...
export function GameResourcesDisplay({ game, canvasRef }: GameResourcesDisplayProps) {
  ...
  return (
    <>
      <input type="checkbox" id="drawer-check" value="1" style={{ display: 'none' }} ></input>
      <div className='verticalStack drawer'>
        <label htmlFor='drawer-check' ><CloseIcon /></label>
